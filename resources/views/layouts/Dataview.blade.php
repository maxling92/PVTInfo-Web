...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#AddPengirim">Tambah Data</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="{{ route('datapengirim.groupAnalysis', request()->except('page')) }}">Analisis Data Kelompok</a>
                    </li>
                </ul>
    ...
    @include('DataPengirim.AddPengirim')
